...
axios.defaults.baseURL = 'https://monitor-backend.jetcamstudio:5000';
...
export default {
  ...
  setup(props) {
    ...
    const initSocket = () => {
      ...
      socket.value = io('https://monitor-backend.jetcamstudio:5000', { 
        path: '/ws',
      ...
      socket.value.on('connect', () => {
        console.log('Connected to WebSocket server at https://monitor-backend.jetcamstudio:5000');
