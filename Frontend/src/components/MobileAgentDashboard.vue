...
below is response from /api/streams
{
  "0": {
    "assignments": [
      {
        "agent_id": 2,
        "created_at": "2025-04-20T00:06:58.811257+00:00",
        "id": 11,
        "stream_id": 12
      }
    ],
    "chaturbate_m3u8_url": "https://edge16-sof.live.mmcdn.com/live-hls/amlst:hiannaa-sd-2fca8e2934ae2614568cadf995476d70dcd1e0afcee097075ffa0f7d60ea9400_trns_h264/playlist.m3u8",
    "id": 12,
    "platform": "Chaturbate",
    "room_url": "https://chaturbate.com/hiannaa/",
    "streamer_username": "hiannaa"
  }
}
get agent_id and stream_id from assignment array and intelligently show if agent_id is same as logged in user before intelligently serving  the livestream using mobilestreamcard componenet with chaturbate_m3u8_url or stripchat_m3u8_url based on stream_ID


maintain naming conventions, only print the script tag of the mobileagentdashboard component, improve code, find optimizations and make code efficient. -->