<template>
  ...
  <!-- New Loading Overlay for Logout -->
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const toggleSettings = () => {
      // Keep existing toggleSettings implementation
    ...
    // Enhanced logout function with fancy animation
    ...
    return {
      ...
      // New logout animation states and refs
      showLogoutOverlay,
      logoutOverlayRef,
      logoutSpinnerRef,
      spinnerCircleRef,
